...
public interface IRenderEngine {
    ...
    /**
     * Initialize the render engine for given canvas dimensions and buffer
     * strategy
     *
     ...
     * @param size font size
     */
    public void drawString(final String text, final int x, final int y, final float size);
    
    /**
     * Render a given string at given coordinates using the current set font in
     * global color
     *
     * @param text a string
     * @param x    x coordinate
    ...
    /**
     * Fill an rectangle area with the drawing color and outline it with given
     * border Color
     *
     * @param x           area top left x coordinate
     * @param y           area top left y coordinate
    ...
    /**
     * Fill an oval area with the drawing color and outline it with given border
     * Color
     *
     * @param x           area top left x coordinate
     * @param y           area top left y coordinate
     ...
     *
     * @param antialiasing the antialiasing flag
     */
