...
public class ColorUtil {
    ...
    public static Color getRandomColor() {
        return colors[ThreadLocalRandom.current().nextInt(20)];
    }
    ...
    /**
     * Returns <code>true</code> if the specified color is pure black (alpha is
     * not verified)
     */
     ...
     * distance.<br>
     * The LAB distance returns a positive value where > 2.3 value is considered
     ...
     * Returns the dominant color from the specified color array.<br>
     * The dominant color is calculated by computing the color histogram from a
     * rainbow gradient and returning the color corresponding to the highest
     * bin.
     *
